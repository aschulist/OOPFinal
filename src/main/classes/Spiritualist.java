...
public class Spiritualist extends CharacterClass{
	...
	private static String basicDescription = 
			" Attuned to the spirits of the dead, a spiritualist forms a bond with a phantom—a returned spirit that has unfinished business but did\n"
			+ " not become undead. This spectral ally can alternate between forms, emerging from the safety of the spiritualist's mind to take on an\n"
			+ " incorporeal form or an ectoplasmic body.";
