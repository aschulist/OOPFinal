...
public class Gunslinger extends CharacterClass{
	...
	private static String basicDescription = 
			" For a renegade few, battle sounds different than it does for the typical fighter. The clash of steel and the sizzle of spell energy are\n"
			+ " drowned out by the thunderous rhythm of gunfire—the pounding beat of the gunslinger.";
