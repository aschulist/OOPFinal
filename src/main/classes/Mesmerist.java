...
public class Mesmerist extends CharacterClass{
	...
	private static String basicDescription = 
			" A mesmerist's piercing stare lets him insinuate himself into other people's minds. A master of enchantment and illusion, the mesmerist\n"
			+ "s controls and influences the behavior of others.";
