...
public class Occultist extends CharacterClass{
	...
	private static String basicDescription = 
			" To make use of his powers, an occultist channels psychic energy into a varied collection of antiques and mementos with storied pasts.\n"
			+ " Every type of implement allows him to use a different school of magic.";
