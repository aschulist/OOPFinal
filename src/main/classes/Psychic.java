...
public class Psychic extends CharacterClass{
	...
	private static String basicDescription = 
			" With her incredibly potent mind, the psychic can cast spells that are more powerful than those of members of any other occult class.\n"
			+ " She accesses these spells through a specific discipline, and can bend and amplify psychic spells as she casts them.";
