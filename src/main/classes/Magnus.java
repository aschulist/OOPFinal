...
public class Magnus extends CharacterClass{
	...
	private static String basicDescription = 
			"There are those who spend their lives poring over ancient tomes and texts, unlocking the power of magic, and there are those who spend their time\n"
			+ " perfecting the use of individual weapons, becoming masters without equal. The magus is at once a student of both philosophies, blending magical\n"
			+ " ability and martial prowess into something entirely unique, a discipline in which both spell and steel are used to devastating effect. As he\n"
			+ " grows in power, the magus unlocks powerful forms of arcana that allow him to merge his talents further, and at the pinnacle of his art, the magus\n"
			+ " becomes a blur of steel and magic, a force that few foes would dare to stand against.";
