...
public class Kineticist extends CharacterClass{
	...
	private static String basicDescription = 
			" With a connection to the elements, a kineticist can bring forth energy in the form of kinetic blasts. Instead of casting psychic spells,\n"
			+ " the kineticist uses unique psychic spell-like abilities called wild talents to manipulate elemental energy and matter.";
